...
**Paso 1:** Calcular pérdida por fricción (Hazen-Williams)

- Material PVC → `C = 150`
- $D = 2" \cdot \frac{25,4 mm}{1"} \cdot \frac{1 m}{1000 mm} = 0,0508m$
- L = 100 m
- $Q = \frac{2L}{s} \cdot \frac{1 m^3}{1000 L} = 0,002 \fracc{m^3}{s}$

Por lo que:

$hf = \frac{10,67 \cdot L \cdot Q^{1,852}}{C^{1,8552} \cdot D^{4,87}}$

$hf = \frac{10,67 \cdot 100 \cdot 0,002^{1,852}}{150^{1,8552} \cdot 0,0508^{4,87}}=2,004 mca$


**Paso 2: Calcular pérdidas localizadas**


hl = 0.15 * hf = 0.15 * 2,004 m ≈ 0.3 m


**Paso 3: Pérdida total**

h_total = hf + hl = 2,004 + 0,3 = **2,304 mca**
