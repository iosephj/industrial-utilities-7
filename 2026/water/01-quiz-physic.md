...
1. Calcular la presión hidrostática en la ducha en Kgf/cm2. (Equivalencia: 1 Kgf/cm2 = 10 mca) <span class = "grey3 size80"> (0.2 pts)</span>

<span hidden>= 0.18 +- 0.01 </span>

<!-- Image -->
<br>
   <center>![](phys_calc_presion8.png){width=400px}</center>
   <center>
...
2. Se trata de un tanque de agua que alimenta una caldera. Calcular la presión hidrostática en el punto "B" a la entrada de la caldera en en Bares. (Equivalencia: 1 kgf/cm² ≈ 0,9807 bar) <span class = "grey3 size80"> (0.2 pts)</span>

<span hidden>= 0.55 +- 0.05</span>

<!-- Image -->
<br>
   <center>![](intensific_ae_1.png){width=400px}</center>
   <center>
      <span class="grey3 size70"></span>
      <span class="grey3 size50"></span>
   </center>
...
3. Muestra y explica al profesor como hiciste los problemas. <span class = "grey3 size80"> (0.4 pts)</span>
