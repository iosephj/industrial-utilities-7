---
title: "Tipos de gas y sus características"
autor: "José Juarez"
version: "10/06/26"
---
...
<!-- Image -->
<br>
   <center>![](gas/gn-pipelines-intro.png){width=400px}</center>
   <center>
...
Los gases más comunes son el Gas Natural (GN) y el Gas Licuado de Petroleo (GLP). Con esta tarea vas a conocer el origen, la obtención y algunas propiedades básicas de estos gases que son utilizados en instalaciones industriales, comerciales y domiciliarias.

<br>

### Consigna

**1. Gas natural (GN)** Observa atentamente este [video](https://www.youtube.com/watch?v=3hUnfEbX2NM) y luego responde:

*a)* Investiga y contesta ¿Cuál de las teorías sobre el origen del gas natural tiene más apoyo hoy en día?

*b)* ¿Cómo se transporta hasta los lugares de consumo?


**2. Gas licuado de petroleo (GLP)** Busca información y responde brevemente:

*a)* ¿Qué significan las siglas GLP?
*b)* ¿De qué sustancias está compuesto principalmente?
*c)* ¿Cómo se obtiene el GLP?
*d)* ¿Cómo se almacena y transporta?
*e)* ¿En qué situaciones se utiliza habitualmente?

**3. Algunas propiedades** Investiga y completa el siguiente cuadro comparativo:

| Propiedad                                            | Gas Natural (GN) | GLP |
| ---------------------------------------------------- | ---------------- | --- |
| Componente principal                                 |                  |     |
| Densidad respecto al aire (más liviano o más pesado) |                  |     |
| Forma habitual de almacenamiento                     |                  |     |
| Poder calorífico (alto, medio o bajo)                |                  |     |
| Olor natural                                         |                  |     |
| ¿Se le agrega odorante para detectar fugas?          |                  |     |


**4. Reflexión:** Redacta un breve texto (5 a 10 líneas) respondiendo: **¿Qué ventajas y desventajas encuentras en el uso del GN y del GLP como fuentes de energía?**
