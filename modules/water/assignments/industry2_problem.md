---
title: "Diseño básico de una instalación de lavado industrial (parte 2)"
autor: "José Juarez"
version: "29/04/26"
---
...
<!-- Image -->
<br>
   <center>![](https://imgs.search.brave.com/ilPvUUGXK1nz1KvXDY0bd837GBg1fqnVFM7S8lGv3G0/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9oaWRy/b2xpbXBpYWRvcmEu/bXgvd3AtY29udGVu/dC91cGxvYWRzLzIw/MjQvMDUvbGF2YWRv/LWRlLWNhamFzLWRl/LXBsYXN0aWNvLWEt/cHJlc2lvbi53ZWJw){width=300px}</center>
   <center>
      <span class="grey3 size70"></span>
      <span class="grey3 size50">Fuente: hidrolimpiadora.mx </span>
   </center>
<br>
...
Asumimos algunos datos y resultados de la parte (1) es decir:

- 4 picos rociadores de 0,4 m³/h que funcionan de manera simultánea.
- Velocidad de diseño: 1,2 m/s.
- Caudal: el que calculaste en parte (1)
- Diámetro interno de la cañería comercial: el que seleccionaste en parte (1)
- El material de la cañería es PVC-U

**Datos nuevos:**

Considerando las distancias máximas:

- Cañería troncal: 30 metros
- La cañería individual del aspersor más alejado: 10 metros
- Los rociadores requieren: 2,8 bar de presión mínima
- Bombas disponibles

| Bomba | Caudal máximo | Altura máxima |
| ----- | ------------- | ------------- |
| A     | 3 m³/h        | 20 m.c.a.     |
| B     | 5 m³/h        | 38 m.c.a.     |
| C     | 8 m³/h        | 55 m.c.a.     |
...
1. Calcular la pérdida de carga por fricción mediante Hazen-Williams.
2. Calcular pérdidas localizadas.
3. Determinar la pérdida total del sistema.
4. Determinar la presión mínima que debe entregar la bomba.
5. Seleccionar la bomba más adecuada y justificar.
6. Indicar si sería conveniente utilizar variador de frecuencia.
